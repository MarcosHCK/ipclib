...
namespace Ipc
{
  ...
  public static string call_unpack (GLib.Variant call, out GLib.Variant @params);
  [CCode (returns_floating_reference = true)]
  public static GLib.Variant reply_pack (GLib.Variant? reply, GLib.Error? error);
  ...
  public class Endpoint : GLib.Object
    {
      ...
      public async GLib.Variant handle (GLib.Variant @params, GLib.Cancellable? cancellable = null) throws GLib.Error;
    }
